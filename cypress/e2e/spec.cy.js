describe('App', () => {
  beforeEach(() => {
    ...
    cy.visit('https://the-hive-mind-cds.herokuapp.com/')
  })
  ...
  it('should be able to click Guides button and see a list of guides, then click the title to go home', () => {
    ...
    .first()
    .click()
    .url().should('eq', 'https://the-hive-mind-cds.herokuapp.com/guides')
    .get('.external-link')
  ...
  it('should be able to click an image in the homescreen to see a decklist, description, and embedded video. Can also click title link to go home', () => {
    ...
    .should('have.length', 3)
    .first().click()
    .url().should('eq', 'https://the-hive-mind-cds.herokuapp.com/tempo')
    .get('.decklist')
    .should('be.visible')
    .get('.youtube')
    .should('be.visible')
    ...
    .should('have.length', 3)
    .last().click()
    .url().should('eq', 'https://the-hive-mind-cds.herokuapp.com/combo')
    .get('.decklist')
    .should('be.visible')
    .get('.youtube')
    .should('be.visible')
  ...
  it('should be able to see a repo of cards, and filter them by card type, then return home', () => {
    ...
    .contains('The Goods')
    .click()
    .url().should('eq', 'https://the-hive-mind-cds.herokuapp.com/cardrepo')
    .get('.card')
