...
const Control = () => {
  ...
  let description = "Welcome to the finer things in life. As all MTG players eventually come to discover, the best way to play Magic is to not play at all. What I mean is, blue's core identity is to be responsive to the opponent's game actions. When it comes to this archetype, it's all about taking it slowly and methodically. Draw a card, play a land, pass the turn. Deal with whatever you opponent plays, rinse and repeat. Out-resource your opponent with two-for-one interactions and draw spells, and come over the top with big swingy finishers they won't be able to deal with. In this video, hall of famer Gabriel Nassif (a lauded control player) demonstrates these core concepts with mastery. Watch as he meticulously chooses when he plays his spells and what spells he chooses to play. It's all done with consideration to the game state, what he might be reading for his opponents hand, and his life total. You wont find a better teacher."
  return (
    <div className='large-container'>
      <div className='decklist-container'>
        <p className='decklist'>{decklist}</p>
        <iframe title='control-video'className='youtube' width="900" height="500" src='https://www.youtube.com/embed/-IWLzwFajjo'></iframe>
      </div>
